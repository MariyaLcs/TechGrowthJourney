...
- **Programming Languages Mastery 💻: 1 hour**:
...
- **Specialisation as a Developer 👩‍💻: 1.5 hours**:
...
- **Interviews 🕴: 0.5 hours**: I spent time preparing for interviews, crucial for sharpening my technical and communication skills.

- **AWS & Testing Tools 🔧: 0.5 hours**: Explored AWS and various testing tools, laying the groundwork for understanding cloud technologies and quality assurance.

- **JavaScript Mastery 💻: 0.5 hours**: Invested time in mastering JavaScript, supported by bootcamps and courses, emphasizing accessible and affordable learning.

- **Career and Personal Branding 🚀: 1 hour**: Focused on personal branding and career development, engaging in mentorship programs and attending technical conferences, enriching my professional journey.

- **Development Specialisation 👩‍💻: 3.5 hours**: Dedicated significant time to development specialisation, completing major projects and additional study to solidify skills.
